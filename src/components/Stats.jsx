...
const Stats = () => {
	return (
		<div>
			<h2 className="text-center font-bold text-3xl my-20">Why Client's Prefer Us</h2>
			<div className="max-w-[1240px] mx-auto flex flex-col lg:flex-row my-30 justify-between">
				<div
				...
				>
					...
					<div className="">
						...
						<h3 className="font-bold text-xl mb-5">Corporate Clients</h3>
						<p className="w-full ">
