...
const AboutUs = () => {
  return (
     <div className="bg-[#4E6FF8]">
      <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row max-w-[1240px] mx-auto  items-center"style={{minHeight : "400px"}}>
      <div className="flex-shrink-0 ">
        <img className="w-full md:w-9/12" src={Aboutimg} alt="" />
      </div>
      <div className="text-[#ffffff] my-9">
        <h3 className="font-bold text-3xl text-center md:text-start">About Us</h3>
        <p className="my-4 text-justify mx-4 md:mx-0">
          A1 Services founded in 2015 with the motive to give services for IT
