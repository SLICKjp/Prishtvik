...
import Econ from "../assets/customers/econ.jpg";
...
import rehau from "../assets/customers/rehau.jpg";
import Schneider from "../assets/customers/Schneider-Electric-Logo.jpg";
		...
		<div className="clientSection flex flex-col justify-center items-center my-10">
			...
			<div className="clientLogoSection flex flex-col justify-evenly items-center">
				...
				<div className="clientLogo flex flex-row justify-evenly items-center">
					...
					<img className="clients" src={sandeep} alt="" />
					<img className="clients" src={sgicare} alt="" />
				</div>
				<div className="clientLogo flex flex-row justify-evenly items-center">
					<img className="clients" src={Thnoprism} alt="" />
