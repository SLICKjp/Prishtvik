...
import HeroBgImg from "../assets/Hero_BG1.png";
...
const HeroSection = ({ onContactClick }) => {
	return (
		...
		>
			<div className=" text-center md:text-start" style={{ width: "60%" }}>
				...
				<p className="text-xl my-7 font-normal text-[#a8a8a8] w-[90%]">
					Converting your ideas into products with engaging designs and scalable
					technology.
				</p>
				<input
					type="button"
